...
<div class="mgmt-dashboard-card settings-card">
    <div class="settings-action-block">
        ...
        <div class="settings-action-block__content">
            <h2>Backup da Organização</h2>
            <p>Baixe um arquivo contendo todas as informações da sua organização, membros, histórico financeiro e eventos.</p>
        </div>
    ...
    <div class="settings-action-block settings-action-block--last">
        ...
        <div class="settings-action-block__content">
            ...
            <p>Envie um arquivo de backup (.sql ou .json) previamente gerado para restaurar os dados da organização.</p>
        </div>
