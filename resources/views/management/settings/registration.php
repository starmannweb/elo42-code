...
<div style="border-bottom: 1px solid var(--color-border-light); margin-bottom: 1.5rem; display: flex; gap: 1.5rem; overflow-x: auto;">
    ...
    <a href="<?= url('/gestao/configuracoes/cadastro-publico') ?>" style="padding-bottom: 0.75rem; text-decoration: none; color: var(--color-primary); border-bottom: 2px solid var(--color-primary); font-weight: 600; white-space: nowrap; display:flex; align-items:center; gap:6px;">
