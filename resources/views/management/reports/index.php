...
<div class="mgmt-kpi-grid mgmt-report-kpi-grid">
    ...
    <div class="mgmt-kpi-card" style="justify-content:space-between;">
        <div>
            ...
            <div style="font-size: 11px; color: #10b981; margin-top: 2px;"><?= (int) ($newMembers ?? 0) ?> novo(s) no período</div>
        </div>
    ...
    <div class="mgmt-kpi-card" style="justify-content:space-between;">
        <div>
            ...
            <div style="font-size: 11px; color: var(--text-muted); margin-top: 2px;">No período selecionado</div>
        </div>
    ...
    <div class="mgmt-kpi-card" style="justify-content:space-between;">
        <div>
            ...
            <div style="font-size: 11px; color: var(--text-muted); margin-top: 2px;">Agenda e celebrações</div>
        </div>
