...
<?php else: ?>
    <div class="mgmt-table-container">
        <table class="mgmt-table">
            <thead>
                <tr><th>Cortesia</th><th>Produto/serviço</th><th>Vínculo</th><th>Prazo</th><th>Utilizações</th><th>Limite</th><th>Válido até</th><th>Status</th><th>Ações</th></tr>
            </thead>
            <tbody>
        ...
        <form method="POST" action="<?= url('/admin/cortesias') ?>" data-loading>
            ...
            <div class="modal__body">
                <div class="modal-grid">
                    ...
                    <div class="form-group" data-benefit-organization-group><label class="form-label">Instituição</label><select name="target_id" class="form-select" data-benefit-organization-select disabled><option value="">Selecione uma instituição</option><?php foreach ($organizations as $organization): ?><option value="<?= (int) $organization['id'] ?>" data-label="<?= e((string) ($organization['name'] ?? '')) ?>"><?= e((string) ($organization['name'] ?? 'Instituição')) ?></option><?php endforeach; ?></select></div>
