        ...
        <aside class="hub-sidebar" id="hub-sidebar" role="navigation" aria-label="Menu do sistema da igreja">
            <div class="hub-sidebar__header">
                <a href="<?= url('/hub') ?>" class="hub-sidebar__logo">
                    <img src="<?= url('/assets/img/logo-color.png') ?>" alt="Elo 42" height="40" class="logo-light" onerror="this.onerror=null;this.src='<?= url('/assets/img/logo.png') ?>'">
                    <img src="<?= url('/assets/img/logo.png') ?>" alt="Elo 42" height="40" class="logo-dark" onerror="this.onerror=null;this.src='<?= url('/assets/img/logo.svg') ?>'">
                </a>
        ...
        <div class="hub-main">
            <header class="hub-topbar">
                ...
                <div class="hub-topbar__right" style="display:flex;align-items:center;gap:1.25rem;">
                    ...
                    <button type="button" class="hub-theme-toggle hub-topbar__link" id="hub-theme-toggle" aria-label="Alternar modo claro e escuro" data-theme-toggle style="background:transparent;border:none;padding:0;color:var(--text-muted);cursor:pointer;display:flex;align-items:center;">
