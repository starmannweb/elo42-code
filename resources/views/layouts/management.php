        ...
        <div class="hub-main">
            <header class="hub-topbar">
                ...
                <div class="hub-topbar__right" style="display:flex;align-items:center;gap:1rem;">
                    ...
                    <a href="<?= url('/hub') ?>" class="hub-topbar__link" style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:6px;background:var(--color-primary);color:var(--color-white);font-weight:700;" title="Ir para Hub"><?= e($initials) ?></a>
                </div>
            </header>
