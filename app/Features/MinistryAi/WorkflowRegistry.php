    ...
    public static function workflows(): array
    {
        return [
            'gerar_sermao' => [
                ...
                'steps' => ['Objetivo', 'Texto ou tema', 'Público e contexto', 'Preferências', 'Revisão'],
                'fields' => [
                    self::select('sermon_type', 'Tipo de sermão', true, [
                    ...
                    self::text('pastoral_emphasis', 'Ênfase pastoral', true, 'Ex.: consolo, arrependimento, missão'),
            ...
            'refinar_rascunho' => [
                ...
                'steps' => ['Objetivo', 'Texto ou tema', 'Preferências', 'Revisão'],
                'fields' => [
            ...
            'culto_ocasional' => [
                ...
                'steps' => ['Objetivo', 'Texto ou tema', 'Público e contexto', 'Revisão'],
                'fields' => [
                    self::select('occasion_type', 'Tipo de ocasião', true, [
                        ['casamento', 'Casamento'],
                        ['culto_funebre', 'Culto fúnebre'],
                        ['acao_gracas', 'Ação de graças'],
                        ['apresentacao_crianca', 'Apresentação de criança'],
                        ['formatura', 'Formatura'],
                        ['ordenacao_pastoral', 'Ordenação pastoral'],
                    ]),
                    self::select('bible_version', 'Versão bíblica', true, self::bibleVersionOptions()),
            ...
            'curriculo_escola_dominical' => [
                ...
                'steps' => ['Objetivo', 'Público e contexto', 'Preferências', 'Revisão'],
                'fields' => [
                    ...
                    self::text('series_theme', 'Tema da série', false, 'Quando criar do zero'),
                    self::text('pedagogical_goal', 'Objetivo pedagógico', true, 'O que a turma deve saber, crer e praticar?'),
                    self::textarea('class_need', 'Necessidade específica da turma', false, 'Opcional'),
            ...
            'pequenos_grupos' => [
                ...
                'fields' => [
                    ...
                    self::select('meeting_count', 'Número de encontros', true, [['4', '4'], ['6', '6'], ['8', '8'], ['10', '10'], ['12', '12']]),
                    self::select('meeting_duration', 'Duração por encontro', true, [['60', '60 minutos'], ['75', '75 minutos'], ['90', '90 minutos']]),
                    self::select('frequency', 'Frequência', true, [['semanal', 'Semanal'], ['quinzenal', 'Quinzenal'], ['mensal', 'Mensal']]),
                    self::select('confessional_layer', 'Camada confessional', true, self::confessionalLayerOptions()),
                ],
            ],
