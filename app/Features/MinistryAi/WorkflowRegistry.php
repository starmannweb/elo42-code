...
final class WorkflowRegistry
{
    ...
    {
        return [
            ['presbiteriana', 'Presbiteriana (IPB)'],
            ['presbiteriana_independente', 'Presbiteriana Independente (IPIB)'],
            ['presbiteriana_renovada', 'Presbiteriana Renovada'],
            ['batista_reformada', 'Batista reformada'],
            ['batista_tradicional', 'Batista (Tradicional)'],
            ['batista_nacional', 'Batista Nacional (ABIN)'],
            ['batista_renovada', 'Batista Renovada'],
            ['congregacional', 'Congregacional'],
            ['pentecostal', 'Pentecostal clássico'],
            ['assembleiana', 'Assembleias de Deus'],
            ['quadrangular', 'Quadrangular (IEQ)'],
            ['neopentecostal', 'Neopentecostal'],
            ['carismatica_independente', 'Carismática Independente'],
            ['metodista', 'Metodista'],
            ['wesleyana', 'Wesleyana'],
            ['luterana', 'Luterana'],
            ['adventista', 'Adventista (IASD)'],
            ['anglicana', 'Anglicana / Episcopal'],
            ['menonita', 'Menonita / Anabatista'],
            ['congregacao_crista', 'Congregação Cristã do Brasil'],
            ['deus_e_amor', 'Deus é Amor'],
            ['brasil_para_cristo', 'O Brasil Para Cristo'],
            ['vineyard', 'Vineyard / Videira'],
            ['batista_livre', 'Batista Livre'],
            ['alianca_crista', 'Aliança das Igrejas Cristãs Evangélicas'],
            ['evangelho_pleno', 'Evangelho Pleno'],
            ['internacional_graca', 'Internacional da Graça'],
            ['sara_nossa_terra', 'Sara Nossa Terra'],
            ['interdenominacional', 'Interdenominacional'],
            ['missionaria', 'Missional / Paraeclesiástica'],
